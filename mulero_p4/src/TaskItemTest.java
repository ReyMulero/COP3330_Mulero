...
class TaskItemTest {
   ...
   @Test
    ...
    public void creatingTaskItemSucceedsWithValidDueDate(){
        assertDoesNotThrow(DateTimeException.class,()-> t.getDueDate() );
        //assertDoesNotThrows(DateTimeException.class,() -> new TaskItem("rey", "", "2020-13-11",false));
    }
    ...
    public void settingTaskItemDueDateFailsWithInvalidDate(){
      ...
      //  assertThrows(DateTimeException.class,() -> new TaskItem("rey", "", "202-13-11",false));
